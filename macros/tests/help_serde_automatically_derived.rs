//! Testing serialization and deserialization behavior when using the `#[help]` attribute when
//! `#[automatically_derived]` is provided.
//!
//! Containers with this attribute are not processed by the `#[help]` attribute.
